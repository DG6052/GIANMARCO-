...
map.getView().fit([-10577744.480765, -2132539.506676, -6118375.985114, 46797.836945], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DETARTAMENTOS </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (15 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '@ DARWIN CHÁVEZ';
            }
